...
function createRequest(tId, uId, fCode, address, length) {
...
var ModbusTcp = function (host, port, options) {
    ...
    this._write = function (fCode, address, length, unitId, callback) {
        if (this._socket) {
            var uId = 0x01;
            if (typeof unitId === "function") {
                callback = unitId;
            } else if (unitId != null && typeof unitId !== "function") {
                uId = unitId;
            }
            ...
            if(validationResult != null) {
                ...
                if (tId < 0) {
                    ...
                    var request = createRequest(tId, uId, fCode, address, length);
...
ModbusTcp.prototype.readCoils = function(address, length, unitId, callback) {
    this._write(0x01, address, length, unitId, callback);
};
