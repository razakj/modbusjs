...
ModbusTcpClient.prototype.readDiscreteInputs = function(address, length, options, callback) {
...
ModbusTcpClient.prototype.writeSingleCoil = function(address, length, options, callback) {
    return this._write(0x04, address, (length > 125 ? 125 : length), options, callback);
};
