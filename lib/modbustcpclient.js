            ...
            if (self._socket && self._connected) {
                ...
                if(!fceHandler) {
                    ...
                    if(validationResult != null) {
                        ...
                        mbapHeaders.writeUInt16BE(6, 4); // Length of pdu + unit id
            ...
            for(var i = 0; i < buf.length; i) {
                ...
                if(self._transactions[tId]) {
                    ...
                    if(error) {
                        ...
                        var response = functioncodes.FUNCTION_HANDLERS[fce].responseBuilder(self._transactions[tId].request, uId, responseLength, buf.slice(i+8, responseLength + 6));
